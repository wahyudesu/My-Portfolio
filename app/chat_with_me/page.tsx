        ...
        <p className="flex-1">
          ...
          <div className="relative group inline-block">
            ...
            <div
              ...
              className="absolute z-10 hidden group-hover:block opacity-100 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm w-72 p-3 space-y-2 text-sm text-gray-500 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-400"
              role="tooltip"
            >
              <div className="font-semibold text-gray-900 dark:text-white">Activity growth - Incremental</div>
              <p>
              ...
              <div className="font-semibold text-gray-900 dark:text-white">Calculation</div>
              <p>
